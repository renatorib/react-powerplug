...
Context `Provider`s and `Consumer`s allow you to easily avoid [prop-drilling](https://blog.kentcdodds.com/prop-drilling-bb62e02cb691). `Consumer` is used identically to `State`.
